    ...
    switch (indexPath.row) {
        ...
        case 4:
        {
            diyVC.dataDic = @{@"title" : @"DIY5",
                              @"image" : @"empty_qq",
                              @"titleStr" : @"无数据",
                              @"detailStr" : @"当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！当前没有数据，请稍后再试吧！",
                              @"btnTitle" : @"重新加载"};
